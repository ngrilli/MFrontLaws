...
#line 150 "CrystalPlasticityDislocationUpdate.mfront"
...
#line 131 "CrystalPlasticityDislocationUpdate.mfront"
dfg_ddg(i, i) += (this->dt) * n * (this->ao) * (pow(stress_ratio, n) / slip_resistance) * sgn * dslip_resistance_dgammadoti;
...
#line 138 "CrystalPlasticityDislocationUpdate.mfront"
dslip_resistance_dgammadotj *= m(i,j) * drho_ssd_dgammadotj;
#line 140 "CrystalPlasticityDislocationUpdate.mfront"
dfg_ddg(i, j) += (this->dt) * n * (this->ao) * (pow(stress_ratio, n) / slip_resistance) * sgn * dslip_resistance_dgammadotj;
